...
test_that("V-Dem loader keeps East Germany (cow 265) consistently across coding systems", {
  skip_if_not_installed("vdemdata")

  vdem <- load_vdem_data("v2x_polyarchy", 1980, 1985, "cow")
  vdem_gw <- load_vdem_data("v2x_polyarchy", 1980, 1985, "gw")

  expect_true(265 %in% vdem$cow)
  expect_true(265 %in% vdem_gw$gw)
})
