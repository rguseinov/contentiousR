...
- **Ruslan Guseinov**. Author, maintainer.
  [](https://orcid.org/0009-0000-1156-9495)

## Citation

Source:
[`inst/CITATION`](https://github.com/rguseinov/contentiousR/blob/HEAD/inst/CITATION)
...
  url = {https://github.com/rguseinov/contentiousR},\
}
